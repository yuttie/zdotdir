...
alias bat='bat --theme="GitHub" --wrap=never'
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context dir vcs virtualenv rbenv time command_execution_time status root_indicator background_jobs)
...
POWERLEVEL9K_CONTEXT_TEMPLATE="%B%n@%m%b"
